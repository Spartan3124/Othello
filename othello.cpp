...
int getRow(char);
int getCol(char);
void performFlip(char, char, Board, bool, int, int);
void getCurrentPiece(bool, char &, char &);
bool isValidMove(int, int, Board, int, int [], int []);
bool isPass(int, int &);
bool isInputQuit(char, char);
bool isValidPositionAt(bool, Board, int, int, char, char);
bool isValidPositionAtNorth(bool, Board, int, int, char, char);
bool isValidPositionAtSouth(bool, Board, int, int, char, char);
bool isValidPositionAtEast(bool, Board, int, int, char, char);
bool isValidPositionAtWest(bool, Board, int, int, char, char);
bool isValidPositionAtNorthEast(bool, Board, int, int, char, char);
bool isValidPositionAtNorthWest(bool, Board, int, int, char, char);
bool isValidPositionAtSouthEast(bool, Board, int, int, char, char);
bool isValidPositionAtSouthWest(bool, Board, int, int, char, char);
void getValidPositions(bool, Board, int [], int [], int &);
void gameOver(Board);
int main()
{
    //test_draw();
...
void play()
{
    ...
    while (!quit)
    {
        ...
        //----------------------------------------------------------------------
        //Playing the game.  getRow() and getCol() get the row and column numbers.
        ...
        while (1)
        {
            int validCol[DEF_ARRAY] = {0}, validRow[DEF_ARRAY] = {0}, validMoves = 0;
...
void init(Board board)
{
    ...
    //TEST CASES
    //board[7][4] = BLACK_PIECE;
    //board[7][3] = BLACK_PIECE;
    //board[0][7] = BLACK_PIECE;
    //board[1][7] = WHITE_PIECE;
    //board[7][1] = WHITE_PIECE;
    //board[7][0] = BLACK_PIECE;
}
...
bool isValidMove(int col, int row, Board board, int validMoves,
                 int validCol[DEF_ARRAY], int validRow[DEF_ARRAY])
{
    bool valid = 0;
    //std::cout << "Valid Moves: " << validMoves << '\n';
...
//------------------------------------------------------------------------------
void getValidPositions(bool turn, Board board, int validCol[DEF_ARRAY], int validRow[DEF_ARRAY],
                       int& validMoves)
{
    char currentPiece = BLACK_PIECE, oppositePiece = WHITE_PIECE;   
    if (turn == BLACK)
...
void gameOver(Board board)
{
    ...
    for (int col = 0; col < BOARD_SIZE; ++col)
    {
        for (int row = 0; row < BOARD_SIZE; ++row)
        {
            ...
            else if (board[col][row] == WHITE_PIECE)
            {
                ++whiteCount;
            }
        }
